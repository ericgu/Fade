...
{
	static void AssertCommand(Command command, const char* s, int count, int serialNumber)
	{
		Assert::AreEqual(s, command.GetString());
		Assert::AreEqual(count, command.GetCount());
