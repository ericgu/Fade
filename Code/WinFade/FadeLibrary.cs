...
namespace WinFade
{
  ...
  [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
  public delegate void LedUpdatedDelegate(int ledGroupNumber, int channel, int brightnessCount, float brightness1, float brightness2, float brightness3, float brightness4);

  [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
  public delegate void LedUpdateCycleDoneDelegate();
